...
if not defined ICE_CANDIDATE_SUMMARY set "ICE_CANDIDATE_SUMMARY=true"
if not defined ICE_CANDIDATE_SUMMARY_DELAY_MS set "ICE_CANDIDATE_SUMMARY_DELAY_MS=5000"
if not defined ICE_CANDIDATE_SUMMARY_MAX_TRACKED_PLAYERS set "ICE_CANDIDATE_SUMMARY_MAX_TRACKED_PLAYERS=256"
...
call start.bat -- ^
  ...
  --ice_candidate_summary="%ICE_CANDIDATE_SUMMARY%" ^
  --ice_candidate_summary_delay_ms="%ICE_CANDIDATE_SUMMARY_DELAY_MS%" ^
  --ice_candidate_summary_max_tracked_players="%ICE_CANDIDATE_SUMMARY_MAX_TRACKED_PLAYERS%" ^
